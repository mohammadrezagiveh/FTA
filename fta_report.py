...
SPEC: Dict[str, Any] = {
    ...
    "roots": {
        "HEU is recovered from rubble": {"p": 1.0},
        "HEU has been moved to a safe location before the war (excluding Esfahan tunnel)": {"p": 0.1},
        ...
        "Iran has stockpiles of centrifuge intact for big plant": {"p": 0.0},
        "Natural Uranium is available": {"p": 1.0},
        "Enrichment related equipments are available": {"p": 1.0},
        "Aluminum shell with channels": {"p": 1.0},
        "High purity PETN": {"p": 1.0},
        "Main charge": {"p": 1.0},
        "Build a neutron initiator or have one": {"p": 1.0},
        "Other components such as EBW, Capacitors, Switches, flyer plate etc.": {"p": 1.0},
        "Assemble the Surrogate Core": {"p": 1.0},
        "Iran can conduct a successful cold test": {"p": 1.0}
    },
    ...
    "conditionals": {
        ...
        "The actual enrichment of natural uranium to WGU in a large enrichment plant within several months": {"parent": "NU to WGU AND", "p_if_true": 1.0, "p_if_false": 0.0},
        ...
        "WGU UF6 to UF4": {"parent": "UF6 to UF4 OR", "p_if_true": 0.95, "p_if_false": 0.0},
        "WGUF4 to WG uranium metal": {"parent": "WGU UF6 to UF4", "p_if_true": 1.0, "p_if_false": 0.0},
        "Melting and pouring into a mold": {"parent": "WGUF4 to WG uranium metal", "p_if_true": 1.0, "p_if_false": 0.0},
        "Molding, Finishing and machining the metal core": {"parent": "Melting and pouring into a mold", "p_if_true": 1.0, "p_if_false": 0.0},
        "Coating the metal core": {"parent": "Molding, Finishing and machining the metal core", "p_if_true": 1.0, "p_if_false": 0.0},
